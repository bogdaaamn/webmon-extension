...
function createInfluencerScreen(payload) {
  ...
  create_new_campaign_div.style.textAlign = 'center'
  ...
  title_previous_campaigns.style.textAlign = 'center'
  ...
  //document.getElementById('details_donation').addEventListener('click', () => {
    ...
    title_details_donation.style.textAlign = 'center'
    ...
    update_campaign_div.style.textAlign = 'center'
...
document.getElementById('influencer').addEventListener('click', () => {
  ...
  document.getElementById('create_new_campaign_btn').addEventListener('click', () => {
    ...
    new_campaign_div.style.textAlign = 'center'
    new_campaign_div.style.top = "-60px"
    ...
    new_campaign_description.style.height = '150px'
...
function details_campaign(campaign_details_data){
  ...
  campaign_performance.style.textAlign = 'center'
...
function createUserScreen(payload_user) {
  ...
  search_for_a_campaign_div.style.textAlign = 'center'
  ...
  search_for_a_campaign_btn = document.createElement('button')
  search_for_a_campaign_btn.type = 'search bar'
  search_for_a_campaign_btn.id = 'search_bar_btn'
  search_for_a_campaign_btn.style.backgroundRepeat='no-repeat'
  search_for_a_campaign_btn.style.backgroundColor='Transparent'
  search_for_a_campaign_btn.style.border='none'
  search_for_a_campaign_btn.style.cursor='pointer'
  search_for_a_campaign_btn.style.overflow='hidden'
  search_for_a_campaign_btn.style.outine='none'
  
  let image_search = document.createElement('img')
  image_search.src = 'search.png'
  image_search.width = '20'
  image_search.height = '20'
  image_search.style.position = 'relative'
  image_search.style.left = '1px'
  image_search.style.top = '4px'
  ...
  title_previous_campaigns_donated.style.textAlign = 'center'
...
document.getElementById('user').addEventListener('click', () => {
  ...
  document.getElementById('donate_selected_campaign').addEventListener('click', () => {
    ...
    title_donation_h2.style.textAlign = 'center'
    ...
    donate_field_btn.style.backgroundRepeat = 'no-repeat'
